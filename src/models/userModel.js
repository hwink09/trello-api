...
const USER_COLLECTION_SCHEMA = Joi.object({
  ...
  // username cắt ra từ email sẽ có khả năng không unique bởi vì sẽ có những tên email trùng nhau nhưng từ những nhà cung cấp khác nhau
...
const update = async (userId, updateData) => {
  try {
    // Lọc từng field mà mình không cho phép cập nhật linh tinh
